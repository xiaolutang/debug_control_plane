...
// 模块依赖
dependencies {
    implementation("com.github.xiaolutang:debug_control_plane:0.5.1")
}
```
...
0.5.1，内部依赖 JitPack 坐标的本核心），Dart 侧 Capability 经
MethodChannel 注册到原生平面。

## 版本 / Version

`0.5.1` —— Kotlin/JitPack、Dart core、Flutter plugin 对齐版本，包含
